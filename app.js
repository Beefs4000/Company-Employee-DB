...
const { getDepartments, addDepartment, deleteDepartment } = require('./models/department');
const { getEmployees, addEmployee, updateEmployee, deleteEmployee} = require('./models/employee');
const { getRoles, addRole, deleteRole } = require('./models/role');
